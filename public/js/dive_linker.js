...
DiveLinker.prototype = (function () {
    function receiveMsg(event) {
        ...
        try {
            ...
            let doByType = {
                ...
                "shakeHand": function () {
                    if (linker._id) return //bind already
                    linker.shakeHand();
                }
            }
    ...
    return {
        ...
        "pendingGetProject": function () {
            return new Promise((resolve, reject) => {
                let checkProject = setTimeout(() => {
        ...
        "getProjectByProm": async function () {
            delete this.project;
            let d = {
                title: "getProject"
            }
            this.post(d);
            return await this.pendingGetProject()
        },
